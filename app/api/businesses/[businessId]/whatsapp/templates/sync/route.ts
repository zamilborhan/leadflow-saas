...
import { syncTemplates } from "@/src/lib/integrations/whatsapp/templates";
...
/**
 * Refresh the cached catalog from Meta. Requires businesses.update
 * (OWNER/ADMIN). Prunes templates Meta no longer lists.
 */
export async function POST(
  ...
  try {
    ...
    const result = await syncTemplates(g.context);
